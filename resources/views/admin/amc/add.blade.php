                ...
                <div class="card-body">
                    ...
                    <form action="{{url('admin/amc/add')}}" method="post" enctype="multipart/form-data">
                       ...
                       <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="amount" class="form-control" required value="{{old('amount')}}" oninput="javascript:this.value=this.value.replace(/[^0-9]/g,'');if(this.value.length>this.maxLength)this.value=this.value.slice(0,this.maxLength);"
                            maxLength="10"
                            >
                        </div>
                       </div>
                       ...
                       <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="series" class="form-control" required value="{{old('series')}}" oninput="javascript:this.value=this.value.replace(/[^0-9]/g,'');if(this.value.length>this.maxLength)this.value=this.value.slice(0,this.maxLength);"
                            maxLength="10"
                            >
                        </div>
                       </div>
